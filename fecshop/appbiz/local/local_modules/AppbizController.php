...
namespace appbiz\local\local_modules;
 ...
 * @since 1.0
 */
class AppbizController extends Controller
{
    public $blockNamespace;

    public function init()
    {
        Yii::$service->page->translate->category = 'appbiz';
        parent::init();
    ...
    public function behaviors()
    {
        ...
        $cors_allow_headers = [$fecshop_uuid,'access-token'];
